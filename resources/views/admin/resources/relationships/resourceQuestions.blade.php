...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-resourceQuestions">
                <thead>
                <tr>
                    <th width="10">
                ...
                @foreach($questions as $key => $question)
                    <tr data-entry-id="{{ $question->id }}">
                        ...
                        <td>
                            @foreach($question->resources as $key => $item)
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-resourceQuestions:not(.ajaxTable)').DataTable({ buttons: dtButtons })
